        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <h1 class="h3 mb-4"> Kelola Tanggapan</h1>
                    <div class="card">
                        <div class="card-header text-white" style="background-color: var(--bs-tertiary-color)"><strong>Laporan Data Tanggapan</strong></div>
                        <div class="card-body">
                            <table id="dataTanggapan" class="display nowrap" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    WHERE dat_pengaduan.status_pengaduan != 'proses' ORDER BY dat_tanggapan.id DESC");
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="" class="btn btn-dark" data-bs-toggle="modal"
                                                data-bs-target="#ubahkelolaPengaduan<?php echo $data['id_pengaduan']; ?>">Ubah</a>
                                        </td>
                                    </tr>

                                    <!-- Modal Kelola Pengaduan -->
                                    <div class="modal fade"
                                        id="ubahkelolaPengaduan<?php echo $data['id_pengaduan']; ?>"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="crud_kelola_tanggapan.php" method="post"
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <select name="status_pengaduan" class="form-control" id="">
                                                                <option value="tolak"
                                                                    <?php echo $data['status_pengaduan'] == 'tolak' ? 'selected' : '' ?>>
                                                                    Tolak</option>
                                                                <option value="terima"
                                                                    <?php echo $data['status_pengaduan'] == 'terima' ? 'selected' : '' ?>>
                                                                    Terima</option>
                                                            </select>
                                                        </div>
                                                        <div class="mb-3">
                                                            ...
                                                            <textarea name="tanggapan" id="" rows="6"
                                                                class="form-control"><?php echo $data['tanggapan'] ?></textarea>
                                                        </div>
